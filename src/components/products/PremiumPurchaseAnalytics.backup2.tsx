...
const PremiumPurchaseAnalytics = () => {
      ...
      if (Array.isArray(productsArray)) {
        ...
        console.log(`Товаров получено с API: ${productsArray.length}, после фильтрации: ${filteredData.length}`)
          ...
          filteredData.map(async (apiProduct: any, index: number) => {
            ...
            // Получаем данные из API аналитики
            let costTry, costRub, expenses, expenseBreakdown, totalCostRub
            ...
            try {
              ...
              if (analyticsData) {
                // Используем данные из API аналитики
  ...
  }, [currencyRates.current, selectedPeriod, fetchSalesData, deliverySettings.deliveryLeadTime, range, showHiddenProducts, normalizeProductName, productNameMapping])
  ...
  // Получение количества товаров в пути из базы закупок
      console.error('Ошибка получения даты прибытия:', error)
      return null
    }
  }
                    ...
                    >
                        ...
                        <TableCell
                          ...
                          sx={{
                            ...
                            minWidth: 85 // Минимальная ширина для валют
                          }}
                        >
                          <Typography
                            variant="body2"
                            sx={{
                              ...
                              color: theme.palette.mode === 'dark' ? '#f9fafb' : '#111827', // text-gray-900
                              textAlign: 'right',
                              whiteSpace: 'nowrap', // Дополнительная защита
                              fontVariantNumeric: 'tabular-nums' // Фиксированная ширина цифр
                            }}
                          >
                        ...
                        >
                                                    <Tooltip
                            title={
                              (product.expenseBreakdown || (typeof product.expenses === 'object' && product.expenses)) ? (
                                <Box sx={{
                                  p: 1.5,
                                  ...
                                  <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.8 }}>
                                    <Box sx={{ display: 'flex', justifyContent: 'space-between', gap: 2 }}>
                                      ...
                                      >
                                        {formatCurrency((product.expenseBreakdown || product.expenses as any).delivery)}
                                      </Typography>
                                    </Box>
                                    <Box sx={{ display: 'flex', justifyContent: 'space-between', gap: 2 }}>
                                      <Typography
                                      ...
                                      >
                                        {formatCurrency((product.expenseBreakdown || product.expenses as any).logistics)}
                                      </Typography>
                                    </Box>
                                    <Box sx={{ display: 'flex', justifyContent: 'space-between', gap: 2 }}>
                                      <Typography
                                      ...
                                      >
                                        {formatCurrency((product.expenseBreakdown || product.expenses as any).advertising)}
                                      </Typography>
                                    </Box>
                                    <Box sx={{ display: 'flex', justifyContent: 'space-between', gap: 2 }}>
                                      <Typography
                                      ...
                                      >
                                        {formatCurrency((product.expenseBreakdown || product.expenses as any).other)}
                                      </Typography>
                                    </Box>
                                    <Box sx={{
                                      display: 'flex',
                                      ...
                                      >
                                        {formatCurrency((product.expenseBreakdown || product.expenses as any).total)}
                                      </Typography>
                                    </Box>
                                  </Box>
                                </Box>
                            ...
                            slotProps={{
                              tooltip: {
                                sx: {
                                  bgcolor: theme.palette.mode === 'dark' ? 'rgba(33, 33, 33, 0.95) !important' : 'rgba(97, 97, 97, 0.9) !important',
                              ...
                              arrow: {
                                sx: {
                                  color: theme.palette.mode === 'dark' ? 'rgba(33, 33, 33, 0.95) !important' : 'rgba(97, 97, 97, 0.9) !important'
                                }
                              }
                            }}
                          >
