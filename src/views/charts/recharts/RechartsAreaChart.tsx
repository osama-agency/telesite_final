          ...
          <div className='bs-[350px]'>
            <ResponsiveContainer>
              <AreaChart height={350} data={data} style={{ direction: theme.direction }} margin={{ left: -20 }}>
                ...
                <Area dataKey='Clicks' stackId='Clicks' stroke='0' fill='rgb(115, 103, 240)' isAnimationActive={true} />
                <Area dataKey='Sales' stackId='Sales' stroke='0' fill='rgba(115, 103, 240, .5)' isAnimationActive={true} />
                <Area dataKey='Visits' stackId='Visits' stroke='0' fill='rgba(115, 103, 240, .2)' isAnimationActive={true} />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </AppRecharts>
